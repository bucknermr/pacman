...
import { equalArrays, deleteFromArray } from './util';
...
class Ghost extends Sprite {
  ...
  retreat() {
    ...
    // this.speed = 4;
    // this.speedRate = 0.25;
    // this.speedRate = this.speedRate * 2;
  }
  ...
  calcPossibleDirs(map) {
    ...
    //
    //   console.log('destination: ', destination, projectedTile);
  ...
  findPath(map, endPos) {
    ...
    const startPos = this.setupPathFinder(map);
